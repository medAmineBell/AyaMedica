...
class TranslationService extends Translations {
  ...
  static const Map<String, String> en = {
    ...
    'password_recovery_subtitle': 'Please enter your registered email to recover your password',
    'contact_support': 'Contact support',
    'proceed': 'Proceed',
    'go_back_to_login': 'Go back to login',
    'email_sent_to': 'We have sent an email to',
    'change_email': 'Change email',
    'otp_subtitle': 'Please enter the code we sent to your email to proceed',
    'resend_code': 'Resend code',
    'new_password_title': 'New password',
    'new_password_subtitle': 'Please enter and validate the new password',
    'enter_your_password': 'Enter your password',
    'repeat_password': 'Repeat',
    'rule_min_length': 'At least 8 characters',
    'rule_upper_lower': 'At least one capital letter and one lowercase letter',
    'rule_special_char': 'At least one special character(!, #, @, etc.)',
    'rule_match': 'Passwords must be identical',
    'complete': 'Complete',
    'password_changed': 'Password changed',
    'password_changed_subtitle': 'Your password has been changed successfully, please login',
    'code_resent': 'Code has been resent to your email',
  ...
  static const Map<String, String> ar = {
    ...
    'password_recovery_subtitle': 'الرجاء إدخال بريدك الإلكتروني المسجل لاسترجاع كلمة المرور',
    'contact_support': 'تواصل مع الدعم',
    'proceed': 'متابعة',
    'go_back_to_login': 'العودة لتسجيل الدخول',
    'email_sent_to': 'لقد أرسلنا بريدًا إلكترونيًا إلى',
    'change_email': 'تغيير البريد الإلكتروني',
    'otp_subtitle': 'الرجاء إدخال الرمز الذي أرسلناه إلى بريدك الإلكتروني للمتابعة',
    'resend_code': 'إعادة إرسال الرمز',
    'new_password_title': 'كلمة مرور جديدة',
    'new_password_subtitle': 'الرجاء إدخال كلمة المرور الجديدة والتحقق منها',
    'enter_your_password': 'أدخل كلمة المرور',
    'repeat_password': 'أعد الإدخال',
    'rule_min_length': 'على الأقل 8 أحرف',
    'rule_upper_lower': 'حرف كبير واحد وحرف صغير واحد على الأقل',
    'rule_special_char': 'رمز خاص واحد على الأقل (!، #، @، إلخ)',
    'rule_match': 'كلمتا المرور يجب أن تكونا متطابقتين',
    'complete': 'إتمام',
    'password_changed': 'تم تغيير كلمة المرور',
    'password_changed_subtitle': 'تم تغيير كلمة المرور بنجاح، الرجاء تسجيل الدخول',
