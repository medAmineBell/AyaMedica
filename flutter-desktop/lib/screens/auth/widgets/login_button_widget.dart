...
class LoginButtonWidget extends StatelessWidget {
  ...
  const LoginButtonWidget({Key? key, required this.authController})
      : super(key: key);
    ...
    return Obx(() {
      ...
      switch (buttonState) {
        case LoginButtonState.valid:
          buttonColor = const Color(0xFF1339FF); // Blue for valid state
          break;
      ...
      return GestureDetector(
        onTap: buttonState == LoginButtonState.disabled
            ? null
