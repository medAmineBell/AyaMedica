...
class _SidebarIconButtonState extends State<_SidebarIconButton> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final bool isActive =
          widget.controller.selectedSideIndex.value == widget.index;
      return MouseRegion(
        ...
        child: GestureDetector(
          onTap: () {
            ...
            if (widget.index == 0) {
              ...
              widget.controller.isSecondSidebarVisible.value = false;
              widget.controller.changeContent(ContentType.support);
            }
          },
          child: Container(
            ...
            child: Center(
              child: SvgPicture.asset(
                ...
                colorFilter: ColorFilter.mode(
                  isActive
                      ? LeftSidebar._activeIcon
                      : LeftSidebar._inactiveIcon,
                  BlendMode.srcIn,
                ),
              ),
            ),
