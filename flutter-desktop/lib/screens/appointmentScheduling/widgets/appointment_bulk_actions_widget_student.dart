...
class AppointmentBulkActionsWidgetStudent extends StatelessWidget {
  const AppointmentBulkActionsWidgetStudent({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Obx(() => Text(
            '${controller.selectedAppointmentStudents.length} student${controller.selectedAppointmentStudents.length == 1 ? '' : 's'} selected',
  ...
  void _showBulkConfirmationDialog(
    ...
    showDialog(
      ...
      builder: (context) => AppointmentConfirmationDialog(
        ...
        message: 'By clicking proceed, all selected students will be marked $action for their appointments',
        onConfirm: () {
          if (markAsDone) {
