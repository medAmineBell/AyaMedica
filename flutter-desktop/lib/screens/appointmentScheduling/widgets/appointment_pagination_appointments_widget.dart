...
class AppointmentPaginationAppointmentsWidget extends StatelessWidget {
  const AppointmentPaginationAppointmentsWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final totalItems = controller.filteredAppointments.length;
