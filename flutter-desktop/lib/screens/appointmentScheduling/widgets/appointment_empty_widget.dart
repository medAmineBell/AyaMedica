...
class AppointmentEmptyWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          SvgPicture.asset(
            'assets/svg/calendar-numberical.svg',
            width: 120,
            height: 120,
          ...
          const Text(
            'You may add new records by clicking New appointment button bellow',
            textAlign: TextAlign.center,
            style: TextStyle(
